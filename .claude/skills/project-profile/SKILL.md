...
7. Run the `$grill-me` interview entry (protocol body: [grilling](../grilling/SKILL.md)). Group related fields for readability, but name every field covered by the question.
