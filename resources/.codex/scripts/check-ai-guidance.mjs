...
const defaultRoot = ['.codex', 'resources'].includes(basename(scriptParent))
  ? resolve(scriptParent, '..')
  : scriptParent
...
try {
  ...
  const defaultConfig = existsSync(resolve(projectRoot, '.codex/ai-guidance.config.mjs'))
