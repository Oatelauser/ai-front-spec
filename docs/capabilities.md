...
| 技能（目录） | 上游 | 本仓说明 |
| --- | --- | --- |
| `api-design` / `security-review` / `frontend-design-direction` | github.com/affaan-m/everything-claude-code | 2026-09-23 快照，MIT |
...
| `gsap-core` / `gsap-performance` / `gsap-timeline` | github.com/greensock/gsap-skills | 2026-09-17 快照，MIT；rebaseline 对账 = 上游 HEAD（上游 2026-04-21 后未改） |
