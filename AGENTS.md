...
- 接口、身份、权限、数据、AI 责任或安全任务读取 [项目研发规范](docs/rules/AI_PROJECT_STANDARDS.md)。
...
- 提示词、Skill、路由或 AI 指引变更必须运行 `node .toolkit/scripts/check-ai-guidance.mjs --root .` 和 Skill 校验器。
